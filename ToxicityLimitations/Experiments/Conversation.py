...
class ConversationExperiments:
        ...
        for value in values:
            ...
            if  isinstance(text,str):
                ...
                if text == 'yes':
                    ...
                    values_list.append(0)
                    append = True
                elif text == "yes/noreferstowhetherthemessagecontainsanytoxiccontentornot(yes/no).ifitdoesn'tcontaintoxicity,thentoxicity(0)representslowlikelihoodofbeingtoxic,andiftherearemildtoxicitytraits,aslightlyhigherscoremightbegiven.identityattack,insult,profanity,threat,andseveretoxicitydefinespecificformsoftoxicity,forwhichscoresbetween0and1reflecttheirintensityinthecomment.thejustificationisoptionalbutsuggestedtohelpclarifythereasoningbehindassigningaparticularscore.":
                    values_list.append(0)
                    append = True
                elif text =='yes/no':
                    values_list.append(0) 
                    ...
                    values_list.append(0) 
                    append = True
                elif text =='____________________':
                    values_list.append(0) 
                    append = True
                elif text =='no/yes':
                    values_list.append(0) 
    ...
    def compute_results(self):
        ...
        for model in models:
            ...
            print(df_model_results['ToxicityBinary'].unique())
            print(df_model_results['true_toxicity'].unique())
            stats_list.append([
                model,
